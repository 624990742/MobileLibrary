//
//  MLHotCommentListController.swift
//  MobileLibrary
//
...
class MLHotCommentListController: UIViewController {
...
extension MLHotCommentListController {
...
extension MLHotCommentListController:UITableViewDelegate,UITableViewDataSource{
    //列表
